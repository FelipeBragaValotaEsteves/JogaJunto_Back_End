...
export const PartidaService = {
  ...
  //async listarDetalhadoPorPartida({ partidaId }) {
  // const rows = await PartidaModel.aggregateDetalhadoPorPartida(partidaId);

  // // estrutura: [{ jogoId, times: [{ timeId, nome, totais: {...}, jogadores: [...] }] }]
  // const byJogo = new Map();
  // const byTime = new Map();
